                ...
                <div class="relative max-w-sm pt-2">
                    ...
                    <div class="relative">
                        <select id="tanggal" name="tanggal"
                            ...
                            required>
                            <option value="2024-10-21" {{ $jadwal->tanggal == '2024-10-21' ? 'selected' : '' }}>Mon, 21
                                October 2024</option>
                            <option value="2024-10-22" {{ $jadwal->tanggal == '2024-10-22' ? 'selected' : '' }}>Tue, 22
                                October 2024</option>
                            <option value="2024-10-23" {{ $jadwal->tanggal == '2024-10-23' ? 'selected' : '' }}>Wed, 23
                                October 2024</option>
                        </select>
                    </div>
...
<div class="mb-4 flex gap-4 pt-5"> -->
                    ...
                    <a href="{{ route('admin.jadwal.main') }}"><button type="button" type="submit"
                            class="bg-gray-300 hover:bg-gray-500 text-gray-800 font-bold py-2 px-4 rounded">
                            Back</button></a>
        </form>
    </div>
</div>
