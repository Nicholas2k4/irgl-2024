...
<div class="justify-center items-center flex min-h-screen">
    <div class="w-[96.6vw] justify-center items-center flex flex-col rounded-2xl mr-4 bg-white">
        ...
        <div class="overflow-auto sm:overflow-x-scroll w-[98%] relative mb-2 px-4">
            <table class="justify-center items-center mt-10 mb-1 w-[150vw]">
                <thead>
                    <tr class="min-w-full">
                        <th class="min-w-[28px]">No</th>
                        <th class="min-w-[100px]">Team</th>
                        <th class="min-w-[112px] max-w-[136px]">Line</th>
                        <th class="min-w-[112px] max-w-[136px]">No Telp</th>
                        <th class="min-w-[90px] max-w-[80px]">Data Anggota</th>
                        <th class="min-w-[90px] max-w-[80px]">Bukti Transfer</th>
                        <th class="min-w-[90px] max-w-[80px]">Action Bukti Transfer</th>
                        <th class="min-w-[150px] max-w-[180px]">Last Edited</th>
                        <th class="min-w-[150px] max-w-[180px]">Team Created</th>
                    </tr>
                </thead>
