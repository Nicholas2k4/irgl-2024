        ...
        <table class="w-[90vw] justify-center items-center mt-10 mb-1">
            ...
            <tbody id="bodyTable" class="text-center">
                ...
                <tr class="bg-white text-center">
                    ...
                    <td>
                        <button class="w-12 h-8 my-2 rounded-[4px] bg-blue-600 hover:bg-blue-800 text-gray-200 text-center">
                        <a href="{{ strpos($data->link_bukti_tf, 'http') === 0 ? $data->link_bukti_tf : 'https://' . $data->link_bukti_tf }}" target="_blank" >View</a>
                        </button>
                    </td>
