...
<div class="w-screen py-[-14px] my-[-14px] flex justify-evenly items-center">
    <img src="\assets\sammy\sam24_hooray.png" class="w-[25vw] pt-[13vh]">
    <h2 class="k px-3 text-white">TOTAL PRIZE : <br><br> RP 62.500.000 </h2>
</div>
<div id="about" class="m bg-white/70 justify-center items-center flex flex-col pb-2 rounded-lg mt-[7.5vh]">
