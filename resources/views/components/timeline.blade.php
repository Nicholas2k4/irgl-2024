...
<div id="timeline" class="min-h-full mt-8 p-8 pt-10 shadow-lg fade-slide-in">
    ...
    <div class="bg-transparent mx-auto w-full h-full">
        ...
        <div class="relative wrap overflow-hidden py-10 h-full fade-slide-in">
            ...
            <div class="mb-8 flex justify-between items-center w-full mx-auto fade-slide-in">
                ...
                <!-- box -->
                <div class="break-words relative order-1 bg-opacity-70 bg-gradient-to-b from-[#b005b5] to-[#181be1] rounded-lg shadow-xl w-5/12 px-6 py-4"
                    data-aos="fade-left" id='tl1'>
            ...
            <div class="mb-8 flex justify-between flex-row-reverse items-center w-full fade-slide-in">
                ...
                <div class="break-words relative order-1 bg-opacity-70 bg-gradient-to-b from-[#b005b5] to-[#181be1] rounded-lg shadow-xl w-5/12 px-6 py-4 left-1"
                    data-aos="fade-right" id='tl2'>
                    <div class="triangle-right"></div>
                    <h3 class="mb-3 font-bold text-white text-xl">19 Oct 2024</h3>
                    <p class="text-lg font-medium leading-snug tracking-wide text-white text-opacity-100">Technical
                        Meeting</p>
                </div>
            </div>
            ...
            <div class="mb-8 flex justify-between flex-row-reverse items-center w-full fade-slide-in">
                ...
                <div class="break-words relative order-1 bg-opacity-70 bg-gradient-to-b from-[#b005b5] to-[#181be1] rounded-lg shadow-xl w-5/12 px-6 py-4 left-1"
                    data-aos="fade-right" id='tl4'>
                    <div class="triangle-right"></div>
                    <h3 class="mb-3 font-bold text-white text-xl">2 Nov 2024</h3>
                    <p class="text-lg font-medium leading-snug tracking-wide text-white text-opacity-100">Semifinal &
                        Final</p>
                </div>
            </div>
        </div>
