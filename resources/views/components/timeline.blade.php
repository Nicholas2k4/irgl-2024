...
<h2 class="text-5xl mb-4 font-bold text-gray-100 p-4 text-center fade-slide-in tracking-wider">TIMELINE</h2>
	...
	<div class="bg-transparent mx-auto w-full h-full">
		...
		<div class="mb-8 flex justify-between items-center w-full mx-auto fade-slide-in">
			...
			<!-- box -->
			<div
			class="break-words relative order-1 bg-opacity-70 bg-gradient-to-b from-[#b005b5] to-[#181be1] rounded-lg shadow-xl w-5/12 px-6 py-4" data-aos="fade-left" id='tl1'>
		...
		<div class="mb-8 flex justify-between flex-row-reverse items-center w-full fade-slide-in">
			...
			<div
			class="break-words relative order-1 bg-opacity-70 bg-gradient-to-b from-[#b005b5] to-[#181be1] rounded-lg shadow-xl w-5/12 px-6 py-4 left-1" data-aos="fade-right" id='tl2'>
		...
		<div class="mb-8 flex justify-between items-center w-full fade-slide-in">
			...
			<div
			class="break-words relative order-1 bg-opacity-70 bg-gradient-to-b from-[#b005b5] to-[#181be1] rounded-lg shadow-xl w-5/12 px-6 py-4" data-aos="fade-left" id='tl3'>
			<div class="triangle-left"></div>
		...
		<div class="mb-8 flex justify-between flex-row-reverse items-center w-full fade-slide-in">
			...
			<div
			class="break-words relative order-1 bg-opacity-70 bg-gradient-to-b from-[#b005b5] to-[#181be1] rounded-lg shadow-xl w-5/12 px-6 py-4 left-1" data-aos="fade-right" id='tl4'>
			<div class="triangle-right"></div>
