...
<body>
    <div class="faq fixed bottom-0 right-0 m-5 z-[1030]">
        <button type="button"
            class="inline-block rounded bg-primary px-6 pb-2 pt-2.5 text-4xl font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2"
    ...
    <div data-twe-modal-init
        ...
        <div data-twe-modal-dialog-ref
            class="pointer-events-none relative bg-transparent flex min-h-[calc(100%-1rem)] w-auto translate-y-[-50px] items-center opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:min-h-[calc(100%-3.5rem)] min-[576px]:max-w-[700px]">
            <div
                ...
                <div class="relative">
                    <div
                        class="chats grid md:w-[700px] sm:w-[380px] max-sm:w-[310px] h-[550px] rounded-3xl overflow-hidden !z-50">
                        <div class="chat-header w-full h-[70px] rounded-t-2xl flex justify-between items-center">
                            ...
                            <!-- Close button -->
                            <button type="button"
                                class="box-content rounded-none border-none mr-6 text-black hover:text-neutral-800 hover:no-underline focus:text-neutral-800 focus:opacity-100 focus:shadow-none focus:outline-none"
                        ...
                        <div
                            ...
                            <div class="flex items-center h-full" data-twe-dropdown-position="dropup">
                                ...
                                <ul class="!transition-none question-container absolute z-[1000] float-left m-0 hidden min-w-max h-[180px] overflow-y-scroll list-none overflow-hidden rounded-lg border-none bg-white bg-clip-padding text-base shadow-lg data-[twe-dropdown-show]:block"
                                    ...
                                    <li class="!block">
                                        <p class="question text-white w-[300px] block border-b-2 px-4 py-2 text-sm max-sm:text-xs font-bold hover:cursor-pointer"
                                            href="#" data-twe-dropdown-item-ref question-code="7">Hadiah</p>
                                    </li>
                                    <li class="!block">
                                        <p class="question text-white w-[300px] block border-b-2 px-4 py-2 text-sm max-sm:text-xs font-bold hover:cursor-pointer"
                                            href="#" data-twe-dropdown-item-ref question-code="8">Lokasi
                                        </p>
                                    </li>
                                </ul>
                            </div>
